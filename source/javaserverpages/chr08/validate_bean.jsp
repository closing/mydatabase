<%@ page contentType="text/html;charset=UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body bgcolor="white">
      <jsp:useBean id="userInfo" class="chr08.UserInfoBean">
      ...
      <form action="validate_bean.jsp" method="post">
        ...
        <table>
          ...
          <tr>
            <td>Birth Date:</td>
            <td>
              <input type="text" name="birthDate" value="<c:out value=" ${userInfo.birthDate} " />">
            </td>
          ...
          <tr>
            <td>Email Address:</td>
            <td>
              <input type="text" name="emailAddr" value="<c:out value=" ${userInfo.emailAddr} " />">
            </td>
          ...
          <tr>
            <td>Lucky number:</td>
            <td>
              <input type="text" name="luckyNumber" value="<c:out value=" ${userInfo.luckyNumber} " />">
            </td>
          ...
          <tr>
            ...
            <td>
              <input type="checkbox" name="food" value="z" ${userInfo.pizzaSelected ? 'checked' : ''}>Pizza
              <br>
              <input type="checkbox" name="food" value="p" ${userInfo.pastaSelected ? 'checked' : ''}>Pasta
              <br>
              <input type="checkbox" name="food" value="c" ${userInfo.chineseSelected ? 'checked' : ''}>Chinese
            </td>
          </tr>
          <tr>
            <td colspan=2>
