...
public class MonthCalendarTag extends SimpleTagSupport {
    ...
    private void evalDayNamePattern(Calendar calendar, int firstDayOfWeek) throws JspException, IOException {
    ...
    private void evalPrePadPattern(Calendar calendar, int firstDayOfWeek) throws JspException, IOException {
    ...
    private void evalDayPatterns(Calendar calendar, int firstDayOfWeek) throws JspException, IOException {
        ...
        for (int i = 0; i < daysInMonth; i++) {
            ...
            if ((day == Calendar.SATURDAY || day == Calendar.SUNDAY) && weekendPattern != null) {
    ...
    private void evalPostPattern(Calendar calendar, int firstDayOfWeek) throws JspException, IOException {
