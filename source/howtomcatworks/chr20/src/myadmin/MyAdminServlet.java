...
public class MyAdminServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException ,ServletException {
    ...
    out.println("<html><head><title>MyAdmin</title></head><body>");
  ...
  private void listAllContexts(PrintWriter out){
    try{
      ...
      while(it.hasNext()){
        ...
        out.println(obj + "<a href=?action=removeContext&contextObjectName=" +URLEncoder.encode(obj.toString(),"UTF-8")+">remove</a><br/>");
      }
    }catch(Exception e) {
