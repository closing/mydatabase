...
import common.servlet.CacheHttpServlet;

public class GuestBookServlet extends CacheHttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res) 
    ...
    getServletConfig().getServletContext().log("GuestBookServlet:doGet");
